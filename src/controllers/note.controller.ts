...
export const getAllNotesOfAUser = async (
  req: Request,
  res: Response<any, { userId: string }>
) => {
  try {
...
export const getAllNotesOfACollection = async (
...
export const saveNote = async (
  req: TypedRequestBody<{ _id: string; body: string; title?: string }>,
  res: Response
) => {
